...
class LLMClient:
    ...
    def __init__(self, verbose: bool = True, truncated: bool = False):
    ...
    def complete(self, system: str, user: str, temperature: float = 0.3, max_tokens: int = 100000) -> str:
        ...
        if self.verbose:
            ...
            # Print full request content unless truncated flag is set
            if not self.truncated:
                print(f"[Nova Debug - LLM] Full System Prompt:")
                print("=" * 80)
                print(system)
                print("=" * 80)
                print(f"[Nova Debug - LLM] Full User Prompt:")
                print("=" * 80)
                print(user)
                print("=" * 80)
        ...
        try:
            ...
            if content:
                ...
                if self.verbose:
                    ...
                    # Always show full content in verbose mode unless explicitly truncated
                    if self.truncated:
                        print(f"[Nova Debug - LLM] Full OpenAI Response (truncated by flag):")
                        print("=" * 80)
                        print(content)
                        print("=" * 80)
                    else:
                        print(f"[Nova Debug - LLM] Full OpenAI Response:")
                        print("=" * 80)
                        print(content)
                        print("=" * 80)
            else:
            ...
            if response.content and len(response.content) > 0:
                ...
                if content:
                    ...
                    if self.verbose:
                        ...
                        # Always show full content in verbose mode unless explicitly truncated
                        if self.truncated:
                            print(f"[Nova Debug - LLM] Full Anthropic Response (truncated by flag):")
                            print("=" * 80)
                            print(content)
                            print("=" * 80)
                        else:
                            print(f"[Nova Debug - LLM] Full Anthropic Response:")
                            print("=" * 80)
                            print(content)
                            print("=" * 80)
                else:
